...
//! - [`Gfni`]
//!     - Like [`Avx2`] but uses the x86(-64) GFNI `GF2P8AFFINEQB` instruction for
//!       multiplication. Requires the `gfni` crate feature and a CPU with GFNI + AVX2.
//! - [`Ssse3`]
